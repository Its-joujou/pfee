    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">Learn Academy</a></div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              ...
              <div class="py-2">
                <h3 class="text-black">Mina Ait Brahim</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              ...
              <div class="py-2">
                <h3 class="text-black">Hajar El Hjouji</h3>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            ...
            <h3 class="mb-4">Soukaina El Hjouji</h3>
            <blockquote>
              <p>&ldquo; I was struggling with my studies but it all changed when I learned about Smart Learn, I'm now a senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
            ...
            if(filter_has_var(INPUT_POST, 'submit')){
              ...
              if(!empty($email) && !empty($name) && !empty($message) && !empty($subject)){
                ...
                if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
                  ...
                  // Passed
                  $toEmail = 'support@Smart Learn.com';
    ...
    <footer class="footer-section bg-white">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h3>Subscribe</h3>
            <p>Keep yourself up to date and receive all kind of news about Smart Learn.</p>
